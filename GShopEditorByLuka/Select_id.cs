...
namespace GShopEditorByLuka
{
    ...
    {
        public Select_id(Form1 f,LBLIBRARY.PWHelper.Elements ds,int[] Items_amount,bool IconsLoaded)
        {
            this.wp = ds;
            this.fm = f;
        ...
        private void Items_grid_DoubleClick(object sender, EventArgs e)
        {
            if (Decision == 0 || Decision == 1)
            {
                ...
                {
                    gf = Properties.Resources.SmallQuestionMark;
                }
                Image bm = Properties.Resources._32x32_Question;
